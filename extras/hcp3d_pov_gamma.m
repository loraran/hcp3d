...
% scatter3(atomcut2(:,1),atomcut2(:,2),atomcut2(:,3),15,[0.8 0 1],'filled'); hold off;
...
subplot(1,2,2); scatter3(atompov2(:,1),atompov2(:,2),atompov2(:,3),15,[0.8 0 1],'filled');
xlabel('x'); ylabel('y'); zlabel('z'); axis equal; view(110,20);
% pause

figure;
scatter3(atompov1(:,1),atompov1(:,2),atompov1(:,3),25,[0 0 1],'filled'); hold on;
scatter3(atompov2(:,1),atompov2(:,2),atompov2(:,3),25,[0.8 0 1],'filled'); hold off;
xlabel('x'); ylabel('y'); zlabel('z');
...
path = strcat('C:/Users/Loren/Desktop/hcp3d_plots/POV-Ray/gamma - ',datestr(clock,'dd-mmm-yyyy HH.MM.SS')); mkdir(path);
