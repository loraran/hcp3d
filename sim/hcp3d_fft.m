function [mgfourier] = hcp3d_fft(fmg,sepDist,clatt,inclangle,atomname,atomcalc,path,coordstep)

path2 = strcat('angle_',num2str(inclangle),'_step_',num2str(coordstep)); mkdir(path,path2); % for hcp3d_fulltilt
...
Imin = 0.000;
Imax = 9.000;
Ncont = 1500; % basic = 500 (ATTENTION: processing time is proportional)
