function [atomdefect,atomcut1,atomcut2] = hcp3d_progcut_gammaZ(fmg,sepDist,clatt,atomproj1,atomproj2,path,coordstep)
...
% ADAPTING MATRIX FOR GAMMA-Z PLANES 
...
axis equal;
hold on;
scatter3(atomcut2(:,1),atomcut2(:,2),atomcut2(:,3),15,[0.8 0 0],'filled');
hold off;
